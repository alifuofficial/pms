...
import { Plus, Printer, Eye, EyeOff, FileDown, ChevronDown } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
              ...
              <div className="flex items-center gap-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-56 bg-white border border-slate-100 rounded-xl shadow-xl p-1 animate-in fade-in slide-in-from-top-2 duration-200 z-50">
                    <DropdownMenuItem 
                      onClick={() => window.open("/admin/units/print-all?autoPrint=true", "_blank")}
                    ...
                    <DropdownMenuItem 
                      onClick={() => window.open("/admin/units/print-all?qrPrinted=false&autoPrint=true", "_blank")}
                      className="flex items-center gap-2 px-3 py-2 text-xs font-semibold text-slate-700 hover:text-slate-900 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors"
                    >
                    ...
                    <DropdownMenuItem 
                      onClick={() => window.open("/admin/units/print-all?qrPrinted=true&autoPrint=true", "_blank")}
                      className="flex items-center gap-2 px-3 py-2 text-xs font-semibold text-slate-700 hover:text-slate-900 hover:bg-slate-50 rounded-lg cursor-pointer transition-colors"
                    >
