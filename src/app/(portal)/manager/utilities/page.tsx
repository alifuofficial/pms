...
export default async function ManagerUtilitiesPage() {
  ...
  return (
    <div className="max-w-[1200px] mx-auto space-y-6 animate-in fade-in duration-500 pb-10">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-slate-900">Utility Billing Manager</h1>
          <p className="text-xs text-slate-500 font-sans mt-0.5">Record and verify utility consumption for your assigned properties.</p>
        </div>
      </div>
