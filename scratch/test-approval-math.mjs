import { addEthiopianMonths, toEthiopian, getEthiopianMonthEnd, getDaysInEthiopianMonth } from "../src/lib/calendar.ts";
...
function simulateApproval(unitName, leaseStartDateStr, paymentDueDateStr, amount) {
